...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 561, 351))
        ...
        self.tabWidget_bottom_left.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.tabWidget_bottom_left.setStyleSheet("")
        ...
        self.l_dial = QtWidgets.QLabel(self.gridLayoutWidget)
        self.l_dial.setMaximumSize(QtCore.QSize(16777215, 48))
        self.l_dial.setStyleSheet("font: 18pt \"Myanmar Text\";")
        self.l_dial.setObjectName("l_dial")
        self.verticalLayout_bottom_right.addWidget(self.l_dial, 0, QtCore.Qt.AlignHCenter)
        self.dial_volume = QtWidgets.QDial(self.gridLayoutWidget)
        self.dial_volume.setObjectName("dial_volume")
        self.verticalLayout_bottom_right.addWidget(self.dial_volume)
        ...
        self.b_update.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.b_update_2.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.l_dial.setText(_translate("MainWindow", "Volume"))
